...
#### Attachments: [`drawing.flag.svg`](./drawing.flag.svg)
...
On analysing this code, we can clearly see characters of the flag in the text element.<br>Hence the flag is `picoCTF{3nh4nc3d_aab729dd}`.
